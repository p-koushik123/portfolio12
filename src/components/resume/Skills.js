...
import html5Image from '../../assets/images/html5-logo.png';
import css3Image from '../../assets/images/css3-logo.png'; 
      ...
      <div className="w-full lgl:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            ...
            <img src={reactImage} alt="React Logo" className="w-16 h-16" />
          ...
          <div className="overflow-x-hidden">
            ...
            <img src={html5Image} alt="HTML5 Logo" className="w-16 h-16" />
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            ...
            <img src={css3Image} alt="CSS3 Logo" className="w-16 h-16" />
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            ...
            <img src={jsImage} alt="JavaScript Logo" className="w-16 h-16" />
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
